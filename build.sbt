...
//    "ch.qos.logback" % "logback-core" % logbackVersion,
    ...
    "io.github.stackableregiments" %% "metl2011" % "3.4.+" exclude("javax.jms", "jms") exclude("com.sun.jdmk", "jmxtools") exclude("com.sun.jmx", "jmxri"), //3.1.0 brings smack v4.1.4, but it's currently got issues.
