...
var BoardPage = function(user) {
    ...
    return Object.create(Page, {
        ...
        worldToScreen: {
					value: function(x,y){return user.execute(sprintf("return worldToScreen(%s,%s)",x,y)).value; }
				},
        screenToWorld: {
					value: function(x,y){return user.execute(sprintf("return screenToWorld(%s,%s)",x,y)).value; }
				},
        ...
        handwrite: { value:function(pts){
            ...
            user.buttonUp();
				...
				selectMode: {
					get: function(){
						return user.element("#selectMode");
					}
				},
				deleteSelection: {
					get: function(){
						return user.element("#delete");
					}
				},
				menuButton: {
					get: function(){
						return user.element("#applicationMenuButton");
					}
				},
				recycleBinMenu: {
					get: function(){
						return user.element("#menuRecycleBin");
					}
				}
    });
}
