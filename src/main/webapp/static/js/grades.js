                                                ...
                                                success:function(remoteGrades){
																										...
																										var failedGrades = _.filter(gradesToSend,function(gts){
																											var matchingGrade = _.find(remoteGrades,function(rg){
																												return rg.gradedUser == gts.gradedUser && (gts.gradeValue === undefined || rg.gradeValue == gts.gradeValue) && (gts.gradeComment === undefined || rg.gradeComment == gts.gradeComment) && (gts.gradePrivateComment === undefined || rg.gradePrivateComment == gts.gradePrivateComment);
																											});
