...
public class Item implements Serializable, Cloneable {
    ...
    public Item action(TypedValue action) {
        setAction(action);
        return this;
    }
    ...
    public Item actor(TypedValue actor) {
        setActor(actor);
        return this;
    }
    ...
    public Item context(TypedValue context) {
        setContext(context);
        return this;
    }
    ...
    public Item target(TypedValue target) {
        setTarget(target);
        return this;
    }
    ...
    public Item timestamp(Double timestamp) {
